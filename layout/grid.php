...
<section class="sc-row">
    <h2 class="sc-col sc-xs4 sc-s12">Grid</h2>
...
<section class="sc-row">
    <h3 class="sc-col sc-xs4 sc-s12">Row</h3>
...
<section class="sc-row">
    <h3 class="sc-col sc-xs4 sc-s12">Columns</h3>
...
<section class="sc-row">
    <h3 class="sc-col sc-xs4 sc-s12">Push, pull and offset</h3>
...
<section class="sc-row">
    <h3 class="sc-col sc-xs4 sc-s12">Hidden</h3>
...
<section class="sc-row">
    <h3 class="sc-col sc-xs4 sc-s12">Media queries</h3>
...
<section class="sc-row">
    <h3 class="sc-col sc-xs4 sc-s12">Grid settings</h3>
