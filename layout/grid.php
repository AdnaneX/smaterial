...
<section class="row">
    <h3 class="col xs4 s12">Columns</h3>
...
<section class="row">
    <h3 class="col xs4 s12">Push, pull and offset</h3>
...
<section class="row">
    <h3 class="col xs4 s12">Hidden</h3>

    <p class="col xs4 s12 m6">
        If you want an element to be hidden for a certain device you can use the following classes:
        <code class="language-css">.xs-hidden</code class="language-css">, <code class="language-css">.s-hidden</code class="language-css">, <code class="language-css">.m-hidden</code>, <code class="language-css">.l-hidden</code> and <code class="language-css">.xl-hidden</code>.
    </p>

    <div class="row">
        <div class="col s2 xs-hidden">
            XSmall hidden
        </div>
...
<section class="row">
    <h3 class="col xs4 s12">Media queries</h3>
    ...
    <ul class="col xs4 s12 m6 offset-m6">
        <li>$xsmall-only</li>
        <li>$small-only</li>
        <li>$medium-only</li>
        <li>$large-only</li>
...
<section class="row">
    <h3 class="col xs4 s12">Grid settings</h3>
