...
<section class="sc-row">
	...
	<p class="sc-col sc-xs4 sc-m6">
		...
		The id <code class="language-css">#sc-nav-button</code> is needed to make the navigation drawer open and close.
		Also the class <code class="language-css">.sc-nav-more</code> is used to open te menu more list.
		The class <code class="language-css">.sc-appbar-menu-more</code> is used to detect wether or not a click is performed outside
