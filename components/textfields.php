...
<section class="row" id="floating">
	<h3 class="col xs4 s12">Floating input</h3>
...
<section class="row" id="floating-dense">
	<h3 class="col xs4 s12">Floating dense input</h3>
...
<section class="row" id="single-line">
	<h3 class="col xs4 s12">Single line-textfield</h3>
...
<section class="row" id="single-line-dense">
	<h3 class="col xs4 s12">Single dense line text field</h3>
    ...
    <div class="col xs4 s12 m6">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div class="single-dense-input icon">
                <input type="email" id="email3">
                <label for="email3">Email</label>
                <i class="material-icons">email</i>
            </div>
...
<section class="row">
	<h3 class="col xs4 s12">Multi-line text field</h3>
