...
<section class="sc-row">
	...
	<p class="sc-col sc-s12 sc-m6">
		...
		So <code>.sc-push-s</code> or <code>.sc-pull-s</code> these examples are for small screen but they work with all sizes named before.
	</p>
...
@extend .sc-col, .sc-s12, .sc-m6, sc-push-m6;
		</pre>
	</code>
</section>
