...
<section class="row">
    <h2 class="col xs4">Color usage</h2>
...
<section class="row">
    <div class="col xs4 m4">
        <h3 class="col xs4 red-text">Red</h3>
        ...
        <div class="row red-a100 body-1-dark">
    ...
    <div class="col xs4 m4">
        <h3 class="col xs4 pink-text">Pink</h3>
        ...
        <div class="row pink-a100 body-1-dark">
    ...
    <div class="col xs4 m4">
        <h3 class="col xs4 purple-text">Purple</h3>
        ...
        <div class="row purple-a100 body-1-dark">
...
<section class="row">
    <div class="col xs4 m4">
        <h3 class="col xs4 deep-purple-text">Deep purple</h3>
        ...
        <div class="row deep-purple-a100 body-1-dark">
    ...
    <div class="col xs4 m4">
        <h3 class="col xs4 indigo-text">Indigo</h3>
        ...
        <div class="row indigo-a100 body-1-dark">
    ...
    <div class="col xs4 m4">
        <h3 class="col xs4 blue-text">Blue</h3>
        ...
        <div class="row blue-a100 body-1-dark">
...
<section class="row">
    ...
    <div class="col xs4 m4">
        <h3 class="col xs4 teal-text">Teal</h3>
...
<section class="row">
    <div class="col xs4 m4">
        <h3 class="col xs4 deep-orange-text">Deep orange</h3>
    ...
    <div class="col xs4 m4">
        <h3 class="col xs4 brown-text">Brown</h3>
...
<section class="row">
    <div class="col xs4 m4">
        <h3 class="col xs4 blue-grey-text">Blue grey</h3>
    ...
    <div class="col xs4 m4">
        <h3 class="col xs4 black-text">Shade</h3>
        ...
        <div class="row white body-1-dark">
