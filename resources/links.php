...
?>
<section class="row">
	<h2 class="col xs4 s12">External links</h2>
...
<section class="row">
	...
	<div class="col xs4 s12 m6">
		...
		<ul>
			...
			<li><a href="https://design.google.com/icons/" target="_blank">Google design icons</a></li>
			<li><a href="http://google.github.io/material-design-icons/" target="_blank">Google IO icons</a></li>
		</ul>
	</div>
...
<section class="row">
	<h3 class="col xs4 s12">Components</h3>
	...
	<div class="col xs4 s12 m6">
		<h4><a href="/components/bottom-navigation.php">Bottom navigation</a></h4>

		<ul>
			<li><a href="http://www.google.com/design/spec/components/bottom-navigation.html" target="_blank">Material Design bottom navigation specs</a></li>
		</ul>
	</div>
...
<section class="row">
	<h3 class="col xs4 s12">Resources</h3>
